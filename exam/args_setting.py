...
def create_args(print_args=False, args_alter_dict=None):
    args = dotdict()
    ...
    if args_alter_dict is not None:
        for key in args_alter_dict.keys():
            print("{} altered from {} to {}".format(key, args[key], args_alter_dict[key]))
            args[key] = args_alter_dict[key]
